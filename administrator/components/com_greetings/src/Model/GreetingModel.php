...
namespace Greetings\Component\Greetings\Administrator\Model;
// No direct access.
...
class GreetingModel extends AdminModel
{
	 ...
	 * @since  1.0.1
	 */
	protected $text_prefix = 'COM_GREETINGS';
	 ...
	 * @since  1.0.1
	 */
	public $typeAlias = 'com_greetings.greeting';
	...
	/**
	 * Method to duplicate an Greeting
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_greetings'))
		{
